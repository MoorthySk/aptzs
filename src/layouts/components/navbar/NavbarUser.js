...
const handleLogout = (event) => {
  LoginService.logoutRequest()
    ...
    .catch((error) => {
      ...
      //this.successMessage((error && error.message) || 'Oops! Something went wrong. Please try again!');
...
class NavbarUser extends React.PureComponent {
  ...
  componentDidMount() {
    ...
    document.addEventListener("click", this.handleLogout, true);
  }

  componentWillUnmount() {
    document.removeEventListener("click", this.handleLogout, true);
  }
  ...
  /*handleLogout = () => {
    LoginService.logoutRequest().then(response => {
