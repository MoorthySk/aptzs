...
class SideMenuGroup extends React.Component {
  ...
  componentDidMount() {
    ...
    //const permissionList = RbacList.rbacMenuList();
   // console.log("currentUser:: " + localStorage.getItem("roleName"));
   // console.log("currentUser:: " + permissionList);
      ...
      <ul className="menu-content">
        {item.children
          ? item.children.map((child) => {
            ...
            if (
              (child.permissions &&
                child.permissions.includes(localStorage.getItem("roleName"))) ||
