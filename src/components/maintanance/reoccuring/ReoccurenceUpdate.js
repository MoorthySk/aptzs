...
class ReoccurenceUpdate extends React.Component {
  ...
  async componentDidMount() {
    var reoccuringId = this.props.match.params.reoccuringId;
    ...
    await axios
      ...
      .then((response) => {
        console.log(
          "Response:::::::::::::" + response.data.reOccuringTask.requestType
        );
        ...
        {(props) => {
          ...
          return (
            <Form onSubmit={props.handleSubmit}>
              <Card>
                <CardHeader>
                  <CardTitle>Reoccuring Task Modify</CardTitle>
                </CardHeader>
                <CardBody>
                  ...
                  <Row>
                    <Col md="6" sm="12">
                      ...
                      <FormGroup className="has-icon-left position-relative">
                        ...
                        <div className="form-control-position">
                          <SubtitlesSharp size={15} color="primary" />
                        </div>
                        <ErrorMessage
                          name="subject"
                          component="div"
                    ...
                    <Col md="6" sm="12">
                      ...
                      <FormGroup className="has-icon-left position-relative">
                        ...
                        <div className="form-control-position">
                          <ContactMail size={15} color="primary" />
                        </div>
                        <ErrorMessage
                          name="description"
                          component="div"
                    ...
                    <Col md="6" sm="12">
                      ...
                      <FormGroup className="has-icon-left position-relative">
                        <Select
                          ...
                          value={categoryTypeList.find(
                            (obj) => obj.value === categoryType || ""
                          )}
                          onChange={this.categoryTypeChange}
                        />
                  ...
                  <Row>
                    <Col md="6" sm="12">
                      <label htmlFor="propertyUnitId" id="addapp">
                        Property Unit Name{" "}
                        <AddCircle
                          size={1}
                    ...
                    <Col md="6" sm="12">
                      ...
                      <FormGroup className="has-icon-left position-relative">
                        ...
                        />
                        <div className="form-control-position">
                          <AlarmAddSharp size={15} color="primary" />
                        </div>
                        <ErrorMessage
                          name="dueAfter"
                          component="div"
                    ...
                    <Col md="6" sm="12">
                      ...
                      <FormGroup className="has-icon-left position-relative">
                        <Select
                          ...
                          name="dueType"
                          options={dueTypeList}
                          value={dueTypeList.find(
                            (obj) => obj.value === dueType || ""
                          )}
                          onChange={this.dueTypeChange}
                        />
                        <ErrorMessage
                          name="dueType"
                          component="div"
                    ...
                    <Col md="6" sm="12">
                      ...
                      <FormGroup className="has-icon-left position-relative">
                        <Select
                          ...
                          name="reoccureRepeat"
                          options={repeatList}
                          value={repeatList.find(
                            (obj) => obj.value === reoccureRepeat
                          )}
                          onChange={this.reoccureRepeatChange}
                        />
                        <ErrorMessage
                          name="reoccureRepeat"
                          component="div"
                    ...
                    <Col md="6" sm="12">
                      ...
                      <FormGroup className="has-icon-left position-relative">
                        <Select
                          ...
                          name="endType"
                          options={endTypeList}
                          value={endTypeList.find(
                            (obj) => obj.value === endType
                          )}
                          onChange={this.endTypeChange}
                        />
                        <ErrorMessage
                          name="endType"
                          component="div"
                    ...
                    <Col md="6" sm="12">
                      ...
                      <FormGroup className="has-icon-left position-relative">
                        ...
                        />
                        <div className="form-control-position">
                          <RepeatOneSharp size={15} color="primary" />
                        </div>
                        <ErrorMessage
                          name="reOccuringCount"
                          component="div"
                    ...
                    <Col md={{ size: 8, offset: 4 }}>
                      <Button.Ripple
                        ...
                        className="mr-1 mb-1"
                      >
                        <CheckSquare size={14} color="primary" />
  ...
  /*handleRequestTypeChange = e => {
    ...
    this.setState({
      reqTypSelected: e.value,
    });
    
    //this.seloption.reqTypSelected=e.target.value;
  };*/

  /*handlePriorityChange = e => {
    
   // this.seloption.prioritySelected=e.target.value;
   this.setState({
    prioritySelected: e.value,
  });
  };*/
