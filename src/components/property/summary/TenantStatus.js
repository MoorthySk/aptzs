...
class TenantStatus extends React.Component {
  state = {
    options: {
      chart: {
        toolbar: {
      ...
      labels: ["New Request", "Accepted", "Rejected"],
      stroke: { width: 0 },
        ...
        <CardBody className="pt-0">
          ...
          <div className="chart-info d-flex justify-content-between mb-1 mt-2">
            <div className="series-info d-flex align-items-center">
              <HighlightOff size="18" className="primary" />
              <span className="text-bold-600 mx-50">New Request</span>
          ...
          <div className="chart-info d-flex justify-content-between mb-1 mt-1">
            <div className="series-info d-flex align-items-center">
              <CheckCircleOutline size="18" className="warning" />
              <span className="text-bold-600 mx-50">Accepted</span>
          ...
          <div className="chart-info d-flex justify-content-between mt-1">
            <div className="series-info d-flex align-items-center">
              <AddCircleOutline size="18" className="danger" />
              <span className="text-bold-600 mx-50">Rejected</span>
