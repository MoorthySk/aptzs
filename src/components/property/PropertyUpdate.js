...
import Helper from "../../components/common/Helpers";
import {
  Card,
  CardHeader,
  CardTitle,
...
class PropertyUpdate extends React.Component {
              ...
              <Card>
                ...
                <CardBody>
                  ...
                  <Row>
                    ...
                    <Col md="6" sm="12">
                      <label htmlFor="proptyManager"> Property Manager</label>
                      <FormGroup className="has-icon-left position-relative">
                        <Select
                          name="proptyManager"
                          options={userList}
                          value={userList.find(
                            (obj) => obj.value === proptyManager
                          )}
                    ...
                    <Col md="6" sm="12">
                      <label htmlFor="propertyPostalCode">
                      ...
                      <FormGroup>
                        ...
                        >
                          <Backup color="secondary" style={{ fontSize: 40 }} />
                        </label>
  ...
  onChange = (e) => {
    ...
    console.log("fileRes " + e.target.files[0]);
  };
  selectManager = (e) => {
